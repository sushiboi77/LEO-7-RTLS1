...
function ascentController {
    parameter desiredAp is 10000,  // target apoapsis
              pitchVelocity is 70, // at what velocity to start gravity turn
              pitchDegrees is 10, // how many dergrees should the vessel be facing at the end
              AoA is 5, // max AOA
              inclination is 0.
